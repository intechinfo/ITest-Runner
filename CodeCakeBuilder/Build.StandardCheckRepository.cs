            ...
            else
            {
                ...
                if( !isLocalCIRelease )
                {
                    if( gitInfo.IsValidRelease )
                    {
                        ...
                        {
                            result.RemoteFeed = new MyGetPublicFeed( "intechinfo-release", "MYGET_RELEASE_API_KEY" );
                        }
                        else
                        {
                            // An alpha, beta, delta, epsilon, gamma, kappa goes to invenietis-preview.
                            result.RemoteFeed = new MyGetPublicFeed( "intechinfo-preview", "MYGET_PREVIEW_API_KEY" );
                        }
                    }
                    else
                    {
                        Debug.Assert( gitInfo.IsValidCIBuild );
                        result.RemoteFeed = new MyGetPublicFeed( "intechinfo-ci", "MYGET_CI_API_KEY" );
                    }
                }
            }
